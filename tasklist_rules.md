...
1. After review passes and before doing task execution, register the tasklist in `taskexec/windskills/tasklistall.md` with `Dir` set to `./` according to the repository `.agent-rules.md`.
